    ...
    public Result getAllTables(String datasourceName, String userId, String schema) {
        ...
        try {
            ...
            if ("MYSQL".equals(datasource.getDsType())) {
                if(!StringUtil.isEmpty(datasource.getExtJson())){
                    String dbName = (String) JSONUtil.parse(datasource.getExtJson()).getByPath("database");
                    list = JdbcUtils.getTable(datasource, dbName);
                }else{
